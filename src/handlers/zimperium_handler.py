...
from src import ZIMPERIUM_HOST, AUTHORIZATION, CONTENT_TYPE, APPLICATION, STATUS_FALSE, ZIMPERIUM_ACTIVATION_API, \
    ...
    USER_ALREADY_DEACTIVATED, NO_USER_TO_DEACTIVATE, USER_NOT_SUBSCRIBED
from src.handlers.subscription_handler import check_sms_subscription_status
...
def activate_zimperium_user():
    try:
        ...
        if user_details:
            ...
            group_id, access_token = get_group_id(provider)
            payload = {
                "email": email,
